...
train_dataloader, test_dataloader = NSYNTH_give_dataloader("/data/atiam_ml_mvae/nsynth-train","/data/atiam_ml_mvae/nsynth-valid",batch_size=batch_size,device=device,transform=transform)
...
if not load and load_recent is False:
    ...
    model= train_VAE(model, train_dataloader, epochs, lr,device,writer, Normalize())    
